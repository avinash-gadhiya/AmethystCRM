...
// -----------------------|| FEATHER (Now Lucide Icons) ||-----------------------//
// The "Feather" route now shows Lucide icons (Feather is the predecessor of Lucide)
  ...
  return (
    <div className="card">
      <div className="card-header flex items-center justify-between">
        <div>
          <h5 className="text-base font-semibold text-gray-800 mb-1">Lucide Icons</h5>
          <p className="text-sm text-gray-400 mb-0">
            Click any icon to copy the React snippet. Use{' '}
